...
public class LeetCode751 {
	/* tricky part is managing the bit manipulations
    1. convert ip addresses back and forth to long
    2. we use either the whole block start from the first bit of current ip or n's largest bit
    3. keep doing until n == 0
